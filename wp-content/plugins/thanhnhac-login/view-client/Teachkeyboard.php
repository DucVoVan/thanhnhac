...
<body>
	<header>
		...
		<div class="right-header">
			<h2>Bảng khảo sát chủ đề keyboard</h2>
		</div>
	</header>
	<div>
	...
	<form action="" method="POST" id="myForm">
		<label>Mục đích bạn muốn học chơi Keyboard là để ? <small style="color:red">*</small></label>
		<div>
		...
		<div >
			...
			<label>Bạn đã trên 10 tuổi (hoặc kiểm soát ngón tay, có khả năng tự giác học tập tốt như người từ 10 tuổi trở lên) chưa? <small style="color: red;">*</small></label>
			<div>
			...
			<label>Khả năng chơi hợp âm của bạn thế nào? <small style="color: red;">*</small></label>
			<label class="a">
	...
	<div class="result"></div>
		...
		<script type="text/javascript">
			...
			$(function () {
               var files = $("#files");
				...
				$("#fileupload").fileupload({
					url: 'http://localhost/thanhnhac/wp-content/plugins/thanhnhac-login/Controller-client/uploads-keyboard.php',
					dropZone: '#dropZone',
					dataType: 'json',
					autoUpload: false
			...
			$('form').on('submit',function(){
				...
				$.ajax({
					url: "http://localhost/thanhnhac/wp-content/plugins/thanhnhac-login/Controller-client/TeachkeyboardCtr.php",
					type: "POST",
					data: {
						question1: value1,
